...
\begin{block}{What is a narrative?}
...
[example headlines/images from blog posts/articles]
...
\begin{itemize}
    ...
    \item good data, and note good data does not nescessarily equal big data
\end{itemize}
...
\begin{frame}{A common tool: regression}
...
\bi
	\myitem Tools to help tell stories with data.
	\bi 
	    \item Software 
	    \item Statistical methods
	\ei
	\myitem Practice developing and conceiving models/stories.
\ei
