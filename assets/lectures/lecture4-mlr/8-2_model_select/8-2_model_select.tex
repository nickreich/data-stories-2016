...
\solnMult{An increase of 1 point in a professor's beauty score is associated with a 0.13 point increase in their evaluation score.}
...
\solnMult{If we hold all other variables in the model constant, there is strong evidence that professor's age is associated with their rating.}
