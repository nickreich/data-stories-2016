...
### Exercise 1
Let's say that we are interested in exploring the model that uses age, smoke and height to predict the outcome. Fit this model. Interpret the coefficients. For now, don't give a confidence interval or interpret our uncertainty.
